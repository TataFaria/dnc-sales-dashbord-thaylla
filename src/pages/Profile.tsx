...
import { CardComponent, Header, FormComponent, StyledButton, StyledH2 } from '@/components'
...
// TYPES
import { InputProps, MessageProps, ProfileData, ProfileEditableData } from '@/types'
